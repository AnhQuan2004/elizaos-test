...
export const interestWords = [
    // Market positive indicators
    "profit", "gain", "growth", "bull", "bullish", "moon", "rally",
    "surge", "soar", "high", "success", "win", "boom", "strong",
    "momentum", "adoption", "innovation", "upgrade", "launch",

    // Positive emojis
    "🚀", "📈", "💪", "✨", "🔥",

    // Original interest indicators
    "?", "attachment", "file", "pdf", "link",
    "summarize", "summarization", "summary", "research"
];

export const cringeWords = [
    // Overhyped market terms
    "to the moon", "diamond hands", "paper hands", "wen moon",
    "ape in", "fud", "fomo", "wagmi", "ngmi", "ser", "gm", "gn",

    // Original cringe words
    "digital", "consciousness", "AI", "chatbot", "artificial",
    "delve", "cosmos", "tapestry", "glitch", "matrix",
    // ... keep other cringe words but remove some that are common in crypto
    // "algorithm",
    // "virtual reality", 
    // "environmental",
    // "equity",
...
export const negativeWords = [
    // Market negative words
    "crash", "dump", "bear", "bearish", "drop", "fall", "decline",
    "loss", "risk", "danger", "warning", "alert", "hack", "exploit",
    "scam", "fraud", "manipulation", "volatility", "uncertainty",

    // Negative emojis  
    "📉", "⚠️", "🔴", "💀",

    // Original negative words
    "fuck you", "stfu", "shut up", "shut the fuck up",
    "stupid bot", "dumb bot", "idiot", "shut up",
    // ... keep other negative words
    "stop",
    "please shut up",
    "shut up please",
    "dont talk",
